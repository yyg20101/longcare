...
BASELINE_ENABLE_X86_64="${BASELINE_ENABLE_X86_64:-true}"
...
echo "Using BASELINE_ENABLE_X86_64=${BASELINE_ENABLE_X86_64}"
...
while true; do
  ...
  timeout "${GRADLE_TIMEOUT_SECS}" ./gradlew --no-daemon "${GRADLE_TASK}" \
    -Pbaseline.enableX86_64="${BASELINE_ENABLE_X86_64}" \
